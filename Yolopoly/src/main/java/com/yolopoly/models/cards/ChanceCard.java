...
public class ChanceCard extends DrawableCard {
    @JsonCreator
    public ChanceCard(@JsonProperty("message")String message, @JsonProperty("isComposed")boolean isComposed, @JsonProperty("isMoving")boolean isMoving, @JsonProperty("moveToIndex")int moveToIndex,
